                                ...
                                <tbody>
                                    @forelse ($peminjamans as $peminjaman)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('bauk/hubungi/' . $peminjaman->telp) }}" target="_blank">
                                                    {{ $peminjaman->nama }}
                                                </a>
                                                <hr class="my-2">
                                                ...
                                                @if ($peminjaman->is_sopir)
                                                    <a href="{{ url('bauk/hubungi/' . $peminjaman->sopir->telp) }}"
                                                        target="_blank">
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn btn-primary btn-sm btn-flat"
                                                    ...
                                                    <i class="fas fa-check d-block d-md-none py-1"></i>
                                                    <span class="d-none d-md-block">Konfirmasi</span>
                                                </button>
                                            </td>
                                        </tr>
                                    @empty
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <form action="{{ url('bauk/peminjaman-kendaraan/' . $peminjaman->id) }}" method="POST">
                            @csrf
                            @method('put')
