                ...
                <div class="row">
                    <div class="col-lg-4 col-12">
                        <div class="small-box bg-info mb-2">
                            ...
                            <a href="{{ url('bauk/peminjaman-kendaraan') }}" class="small-box-footer">
                                Lihat Data
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="small-box bg-info mb-2">
                            ...
                            <a href="{{ url('bauk/ruang') }}" class="small-box-footer">
                                Lihat Data
                                <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="small-box bg-info mb-2">
                            ...
                            <a href="{{ url('bauk/gedung') }}" class="small-box-footer">
                                Lihat Data
                                <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="small-box bg-info mb-2">
                            ...
                            <a href="{{ url('bauk/barang') }}" class="small-box-footer">
                                Lihat Data
                                <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
