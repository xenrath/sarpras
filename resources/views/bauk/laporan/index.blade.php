                                ...
                                <tbody>
                                    @forelse ($peminjamans as $peminjaman)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('hubungi/' . $peminjaman->telp) }}" target="_blank">
                                                    {{ $peminjaman->nama }}
                                                </a>
                                                <hr class="my-2">
                                                ...
                                                @if ($peminjaman->is_sopir)
                                                    <a href="{{ url('hubungi/' . $peminjaman->sopir->telp) }}"
                                                        target="_blank">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="row mb-2">
                                                            ...
                                                            <div class="col-md-6">
                                                                <a href="{{ url('hubungi/' . $peminjaman->telp) }}"
                                                                    target="_blank">
                                                                    {{ $peminjaman->nama }}
                                                                </a>
                                                            </div>
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <a href="{{ url('bauk/laporan/bukti/' . $peminjaman->id) }}"
