...
@section('title', 'Peminjaman Gedung')
                        ...
                        <div class="card">
                            ...
                            <form action="{{ url('peminjaman/pembelajaran') }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-2">
                                        <label for="keterangan">Nama Ruang</label>
                                        <input type="text" class="form-control rounded-0" id="keterangan"
                                            name="keterangan" placeholder="Masukan Nama Ruang"
                                            value="{{ old('keterangan') }}">
                                    </div>
                                    <div class="form-group mb-2">
                                        <label for="lampiran">Lampirkan Surat Tugas</label>
                                        <input type="file" class="form-control rounded-0" id="lampiran"
                                    ...
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="telp"
                                            name="telp" placeholder="Nomor WA Peminjam"
                                            value="{{ old('telp') }}">
                                    </div>
                                    <br>
