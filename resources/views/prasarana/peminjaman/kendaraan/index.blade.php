                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="float-right">
                            <a href="" style="text-decoration: underline">Menunggu Tahap 2</a>
                        </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                                            ...
                                            <div class="modal fade show" id="modal-kendaraan-{{ $peminjaman->id }}">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="{{ url('sarpras/peminjaman-kendaraan/kendaraan/' . $peminjaman->id) }}"
                                                            method="post">
                                                            @csrf
                                            ...
                                            <div class="modal fade show" id="modal-edit-{{ $peminjaman->id }}">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form
                                                            action="{{ url('sarpras/peminjaman-kendaraan/' . $peminjaman->id) }}"
                                                            method="post">
                                                            @csrf
                                                            @method('PUT')
                                                            <div class="modal-body">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                <button type="button"
                                                                    class="btn btn-default btn-sm btn-flat"
                                                                    data-dismiss="modal">Batal</button>
                                                                <a href="{{ url('sarpras/peminjaman-kendaraan/proses/' . $peminjaman->id) }}"
