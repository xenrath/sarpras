                                    ...
                                    @forelse ($peminjamans as $peminjaman)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @if ($peminjaman->status == 'menunggu')
                                                    <a href="{{ url('sarana/peminjaman-kendaraan/' . $peminjaman->id) }}"
                                                        ...
                                                        @if ($peminjaman->status != 'menunggu')
                                                            <div class="alert alert-info rounded-0 mb-2">
                                                                @if ($peminjaman->status == 'proses')
                                                                    Menunggu Konfirmasi dari <strong>Pjs. Sarpras</strong>
                                                                @elseif ($peminjaman->status == 'konfirmasi')
                                                                    Menunggu Konfirmasi dari <strong>Ka. Administrasi
                                                                        Umum</strong>
                                                                @endif
                                                            </div>
                                                        @endif
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default btn-sm btn-flat"
                                                                data-dismiss="modal">Batal</button>
                                                            <form
                                                                action="{{ url('sarpras/peminjaman-kendaraa/' . $peminjaman->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('delete')
                                                                <button type="submit"
