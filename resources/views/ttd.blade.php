...
<body>
    ...
    <table style="width: 100%;" class="table-1" cellspacing="0" cellpadding="10">
        ...
        <tr>
            <td class="td-1" width="120px">Waktu</td>
            <td class="td-1" width="20px" style="text-align: center">:</td>
            <td class="td-1">
                {{ Carbon\Carbon::today()->translatedFormat('d F') }}, 08:00-12:00
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="td-1" width="20px" style="text-align: center">:</td>
            <td class="td-1">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Corrupti, harum!</td>
        </tr>
        <tr>
            ...
            <td colspan="3" class="td-1">
                <div class="catatan">
                    ...
                    <ol style="padding: 0px 16px; margin-top: 0px; margin-bottom: 0px;">
                        <li>
                            Kendaraan hanya dipergunakan untuk kepentingan kegiatan internal Universitas Bhamada Slawi
                            dan
                            tidak diperkenankan penggunaannya untuk keperluan pribadi kecuali untuk kepentingan darurat
                            pribadi dan keluarga (karena sakit) sesuai dengan perturan YPTSH No. 011/YPTSH/V/2017
                            tanggal 30
                            Mei 2017
                        </li>
                        <li>
                            Pengemudi sebelum menggunakan kendaraan wajib membersihkan kendaraannya dan mengecek
                            kekurangan
                            atau kerusakan
                        </li>
                        <li>
                            Pengemudi bertanggungjawab atas segala kerusakan dan mengganti semua kerusakan akibat
                            kelalainnya
                        </li>
                        <li>
                            Kerusakan akibat orang lain, pengemudi tetap bertanggungjawab dengan menyelesaikan
                            kerusakannya
                        </li>
                        <li>
                            Melaporkan segala kekurangan dan kerusakan pada Pengelola
                        </li>
                        <li>
                            Formulir berlaku hanya sekali peminjaman
                        </li>
                    </ol>
                </div>
            </td>
